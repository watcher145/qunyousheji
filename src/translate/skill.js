...
export const skillTranslate = {
	...
	qunyou_yongli: "拥立",
	qunyou_yongli_info: `锁定技，每轮开始时，你选择一名其他角色，令其获得${get.poptip("tianming")}直到本轮结束，若其武将牌上有${get.poptip("tianming")}，则改为令其获得${get.poptip("twzhuiting")}直到本轮结束。若\u201C拥立\u201D角色死亡，你获得${get.poptip("shanhe_yunmo")}并失去\u201C扶主\u201D直到你下次发动\u201C拥立\u201D。`,
	shanhe_taoning: "讨佞",
	...
	qiufeng_fuyao: "复谣",
	qiufeng_fuyao_info: "与你武将牌状态不同的角色回合结束时，你可以与上名因获得牌的其他角色拼点，赢者可以令你展示手牌，若其中有❤牌，你回复1点体力并交换双方武将牌状态。",
	...
	qiufeng_xixin: "悉心",
	qiufeng_xixin_info:
		"一名角色的回合开始时，你可以依次弃两张牌，声明第一张牌的类型和第二张牌的花色；本回合结束时，你获得本回合弃牌堆一张花色类型皆与声明相符的牌；若无对应牌，你摸三张牌。",
	qiufeng_paoshi: "袍虱",
	qiufeng_paoshi_info:

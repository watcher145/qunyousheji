...
export const zhuomingTranslate = {
	...
	zhuoming_tingfeng: "挺锋",
	zhuoming_tingfeng_info:
			"攻击范围包含你的角色回合开始时，你可对其使用至多体力值张牌，然后若以此法造成过伤害，此回合仅你可受到伤害。以此法使用过牌的回合结束时，若该回合内其造成的伤害数小于你，你摸两张牌；否则你对其造成1点伤害。",
	zhuoming_gongyan: "功延",
	zhuoming_gongyan_info:
			"锁定技，你造成的致命伤害或本轮你对一名角色第二次造成伤害后，令你摸牌阶段摸牌数+1，受到的致命伤害，防止之，令你摸牌阶段摸牌数-1。你未摸牌的摸牌阶段结束时，你使用两张【杀】或死亡。",
};
